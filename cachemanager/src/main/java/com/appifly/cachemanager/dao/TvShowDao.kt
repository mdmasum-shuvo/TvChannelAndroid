...
interface TvShowDao {
    ...
    @Query("select  tv_show_table.imageUrl,tv_show_table.date,tv_show_table.title,tv_show_table.channelId,channel_table.iconUrl from tv_show_table  LEFT JOIN channel_table Where tv_show_table.channelId=channel_table.id")
