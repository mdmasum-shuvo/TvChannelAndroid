...
dependencies {
    ...
    implementation("androidx.media3:media3-exoplayer:${rootProject.extra.get("mediaVersion")}")
    implementation("androidx.media3:media3-ui:${rootProject.extra.get("mediaVersion")}")
    implementation("androidx.media3:media3-exoplayer-dash:${rootProject.extra.get("mediaVersion")}")
