...
android {
    ...
    productFlavors {
        ...
        create("pro") {
            dimension = "firebase"
            applicationId = "com.appifly.tvchannel"
            buildConfigField("String","BANNER_ADD_ID","\"" + "ca-app-pub-5425280841712168/3539466700"+ "\"")
            buildConfigField("String","INTERSTITIAL_ADD_ID","\"" + "ca-app-pub-5425280841712168/6960655201"+ "\"")
